...
class Logger(object):
    ...
    def log_msg(cls, msg):
        ...
        Args:
            msg (string): log msg
        """
        print("{0}{1}{2}".format(cls.CLR_MSG, cls.log_format(msg), cls.CLR_END))
    ...
    def log_success(cls, msg):
        ...
        Args:
            msg (string): log msg
        """
        print("{}{}{}".format(cls.CLR_SUCCESS, cls.log_format(msg), cls.CLR_END))
    ...
    def log_warning(cls, msg):
        ...
        Args:
            msg (string): log msg
        """
        print("{}{}{}".format(cls.CLR_WARNING, cls.log_format(msg), cls.CLR_END))
    ...
    def log_error(cls, msg):
        ...
        Args:
            msg (string): log msg
        """
        print("{}{}{}".format(cls.CLR_ERROR, cls.log_format(msg), cls.CLR_END))
    ...
    def log_info(cls, msg):
        ...
        Args:
            msg (string): log msg
        """
        print("{}{}{}".format(cls.CLR_INFO, cls.log_format(msg), cls.CLR_END))
    ...
    def log_debug(cls, msg):
        ...
        if not cls.debug:
            return
        print("{}".format(cls.log_format(msg)))
